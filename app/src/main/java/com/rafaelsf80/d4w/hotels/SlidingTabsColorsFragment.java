...
/**
 * A basic sample which shows how to use {@link com.rafaelsf80.materialdesign.SlidingTabLayout}
...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    static class SamplePagerItem {
        ...
        SamplePagerItem(CharSequence name, CharSequence description, int total, int available, CharSequence rooms, int indicatorColor, int dividerColor) {
        	mName = name;
        ...
        Fragment createFragment() {
            return ContentFragment.newInstance(mName, mDescription, mTotal, mAvailable, mRooms, mIndicatorColor, mDividerColor);
        }
